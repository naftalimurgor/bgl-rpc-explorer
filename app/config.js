...
module.exports = {
    ...
    siteTools: [
        ...
        // @todo: disable: not needed
        /* 13 */    {
            name: "Whitepaper Extractor",
            url: "./bitcoin-whitepaper",
            desc: "Extract the Bitcoin whitepaper from data embedded within the blockchain.",
        ...
        /* 16 */    {
            name: "Next Block",
            url: "./next-block",
            desc: "View a prediction for the next block, based on the current mempool.",
